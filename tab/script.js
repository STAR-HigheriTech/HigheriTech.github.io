        ...
        function deleteCard(index) {
            if (confirm('&#x786E;&#x5B9A;&#x8981;&#x5220;&#x9664;&#x8FD9;&#x4E2A;&#x5361;&#x7247;&#x5417;&#xFF1F;')) {//确定要删除这个卡片吗？
                appState.cards.splice(index, 1);
                renderCards();
                saveSettings();
                showNotification('&#x5361;&#x7247;&#x5DF2;&#x5220;&#x9664;');//卡片已删除
            }
        }
        ...
        function saveCard() {
            ...
            if (!title || !url) {
                showNotification('&#x8BF7;&#x586B;&#x5199;&#x6807;&#x9898;&#x548C;&#x7F51;&#x5740;');//请填写标题和网址
                return;
            }
            ...
            if (addingNewCard) {
                ...
                showNotification('&#x5361;&#x7247;&#x6DFB;&#x52A0;&#x6210;&#x529F;&#xFF01;');//卡片添加成功
                ...
                showNotification('&#x5361;&#x7247;&#x66F4;&#x65B0;&#x6210;&#x529F;&#xFF01;');//卡片更新成功
            }
        ...
        function saveEngine() {
            ...
            if (!name || !url) {
                showNotification('&#x8BF7;&#x586B;&#x5199;&#x540D;&#x79F0;&#x548C;&#x7F51;&#x5740;');//请填写名称和网址
                return;
            }
            ...
            if (addingNewEngine) {
                ...
                showNotification('&#x641C;&#x7D22;&#x5F15;&#x64CE;&#x6DFB;&#x52A0;&#x6210;&#x529F;&#xFF01;');//搜索引擎添加~~~
                ...
                showNotification('&#x641C;&#x7D22;&#x5F15;&#x64CE;&#x66F4;&#x65B0;&#x6210;&#x529F;&#xFF01;');//搜索引擎更新~~~
            }
            ...
            wallpaperFile.addEventListener('change', (e) => {
                ...
                if (file) {
                    ...
                    reader.onload = (event) => {
                        ...
                        wallpaperElement.style.backgroundImage = `url(${appState.wallpaper})`;
                        saveSettings();
                        showNotification('&#x58C1;&#x7EB8;&#x8BBE;&#x7F6E;&#x6210;&#x529F;&#xFF01;');//壁纸设置成功！
                    };
